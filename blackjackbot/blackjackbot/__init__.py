...
ban_command_handler = CommandHandler("ban", admin.ban_user_cmd)
unban_command_handler = CommandHandler("unban", admin.unban_user_cmd)
...
handlers = [banned_user_handler,
            ...
            newgame_callback_handler, reload_lang_command_handler, language_command_handler, users_command_handler,
